...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      setMessage("Por favor ingresa un correo y contraseña validos");
      console.log(error);
    }
  };
  const handleGoogleSignIn = async () => {
    try {
      ...
      navigate("/");
       ...
       alert("Error al iniciar sesión con Google");
      console.error(error);
    }
  };
  return (
    <div className="h-[calc(100vh-120px)] flex items-center justify-center">  
      <div className="w-full max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <p className="text-gray-600 text-sm mt-4 align-baseline">
